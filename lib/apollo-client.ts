...
export const authMiddleware = (accessToken: Maybe<AccessToken>): ApolloLink =>
...
export function initializeApollo(
  ...
  accessToken: Maybe<AccessToken> = null
 ...
 * @param initialState
 */
export function useApollo(pageProps: any, accessToken: Maybe<AccessToken>): ApolloClient<NormalizedCacheObject> {
